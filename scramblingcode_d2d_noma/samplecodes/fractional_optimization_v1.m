...
ep_lamk     = 1;%epsilon 2
ep_upk      = 1;%epsilon 2
grad_uk     = 0;%gradient of lagrangian function
...
d4 = 10; d3 = 9;
d2 = 4; d1 = 3;    %Distances of users from rx
...
sum_rate = C1+C2+C3+C4;
sum_lambda = l1+l2+l3+l4;

grad_uk = sum_rate - beta(1)*E_circuit-sum_lambda+...
...
%find the expresion for data thorughput in a sic triangle 
%find the SINR to find the througput
%find throughput per user

%for the total number of K users 
for k = 1:K
